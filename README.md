...
### 未着手
- リポジトリ初期化 (README以外のファイル)
- Genkit + Vertex AI の PoC
- Walking Skeleton (PDF upload → Curator → 結果表示 → Cloud Run デプロイ)
- 2ヶ月マイルストーンの確定
- Knowledge Inventory ビジュアル (ヒートマップで確定、実装未着手)
- Curator 分類体系の最終確定
...
2. [docs/open-questions.md](docs/open-questions.md) — 未決定事項
3. [docs/decisions.md](docs/decisions.md) — 何を決めたか、なぜか

その後、PoC着手なら [docs/architecture.md](docs/architecture.md) と [docs/tech-stack.md](docs/tech-stack.md)。
