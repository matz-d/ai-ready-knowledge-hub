...
- [x] [docs/decisions.md](decisions.md) に `D-P3-H-6` ドラフトがある
...
- [ ] `D-P3-H-6` Q2（slide fallback）または Q5（Masker タイミング）の product 確定 — 未決のまま subtype 2 M1 に入る場合はドラフト推奨案 (b) を前提とする
