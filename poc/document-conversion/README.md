...
`slide-pdf` runner の cost、失敗時挙動、`coverage` / `locator_quality` の暫定閾値候補は [docs/phase-3-h-slide-pdf-poc.md](../../docs/phase-3-h-slide-pdf-poc.md) に記録する。本線 upload route には統合しない。
