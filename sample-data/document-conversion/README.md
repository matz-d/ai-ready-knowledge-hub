...
| 7 | `synthetic-unmaskable-pii-scan.pdf` | **live smoke `unmaskablePiiFindings.count > 0` 証跡** | 合成 fax page を fold bands + low-resolution raster + blur + seeded noise で scan 化（`generate-synthetic-unmaskable-pii-scan.ts`） | ✅ |
